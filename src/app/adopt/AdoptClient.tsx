    ...
    return (
      <section className="bg-green-950/30 border border-green-900 rounded-xl px-4 py-6">
        ...
        <div className="flex gap-2">
          <Link
            href="/chat"
            className="text-sm px-4 py-2 rounded-lg bg-ink text-cream font-semibold hover:bg-coral-deep"
          >
            Open chat →
          </Link>
          <a
  ...
  return (
    <section className="bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-5">
      ...
      {!ready ? (
        ...
        <button
          onClick={login}
          className="w-full text-sm px-4 py-2 rounded-lg bg-ink text-cream font-semibold hover:bg-coral-deep"
        >
        ...
        <>
          ...
          <button
            ...
            className="w-full text-sm px-4 py-2 rounded-lg bg-ink text-cream font-semibold hover:bg-coral-deep disabled:bg-zinc-800 disabled:text-zinc-500"
          >
